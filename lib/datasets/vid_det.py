...
class vid_det(imdb):
    # VID + DET combined dataset
    def __init__(self, image_set, year, det_ratio, vid_ratio, devkit_path=None):
        imdb.__init__(self, 'vid_det_{}_{}_det{}_vid{}'.format(year, image_set, det_ratio, vid_ratio))
        self._year = year
